...
<!--
__TODO__: [Klara] KU Loket has renewed several tools (e.g., room booking interface). Review each section of this page against the current KU Loket interface and update screenshots and instructions accordingly. Search the entire page for any remaining references to "Clustermarket" and replace with "Calira". Confirm that Klara is listed as the contact person (replacing Christophe) for Calira access.
__TODO__: [Klara] Incorporate info from Jasmine's presentation to LBP on 08/10/2025. Key changes: (1) flight booking has changed from Omnia to Diversity Travel — update the "Order stuff" section accordingly, (2) incorporate any other procedural updates from the presentation. Jasmine has agreed to review this page once updated.
