...
For me, bidsmreye only worked using the T1w fmriprep output space. This is likely because, for some reason, the functional images in MNI space have a wrong TR after fmriprep. For instance:
...
def main():
    # Define file paths
    files = {
        "BIDS": "/data/projects/chess/data/BIDS/sub-42/func/sub-42_task-exp_run-1_bold.nii",
        "fMRIPrep MNI": "/data/projects/chess/data/BIDS/derivatives/fmriprep/sub-42/func/sub-42_task-exp_run-1_space-MNI152NLin2009cAsym_res-2_boldref.nii.gz",
        "fMRIPrep T1w": "/data/projects/chess/data/BIDS/derivatives/fmriprep/sub-42/func/sub-42_task-exp_run-1_space-T1w_desc-preproc_bold.nii.gz",
    }
...
This script checks the TR from the header in three files: a nifti file in the main BIDS folder, and the same file after preprocessing in T1w and MNI space. This is what I get:

```
--- Analyzing BIDS file: /data/projects/chess/data/BIDS/sub-42/func/sub-42_task-exp_run-1_bold.nii ---
Data shape: (112, 112, 60, 152)
Voxel size: (2.0, 2.0, 2.7, 2.0)
TR: 2.0 seconds
No empty slices found.
No NaN values found in the data.

--- Analyzing fMRIPrep MNI file: /data/projects/chess/data/BIDS/derivatives/fmriprep/sub-42/func/sub-42_task-exp_run-1_space-MNI152NLin2009cAsym_res-2_boldref.nii.gz ---
...
--- Analyzing fMRIPrep T1w file: /data/projects/chess/data/BIDS/derivatives/fmriprep/sub-42/func/sub-42_task-exp_run-1_space-T1w_desc-preproc_bold.nii.gz ---
Data shape: (70, 96, 54, 152)
Voxel size: (2.0, 2.0, 2.7, 2.0)
TR: 2.0 seconds
No empty slices found.
No NaN values found in the data.
