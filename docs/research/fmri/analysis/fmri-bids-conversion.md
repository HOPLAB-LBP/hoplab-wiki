...
!!! info "Next steps: Data storage"
    Once your data is in BIDS format, make sure to follow the lab's [data management guidelines](../../rdm/SOPs.md) for storing and backing up your dataset. See the [ManGO guide](../../rdm/mango_active.md) for uploading your data to the lab's active research data storage.
